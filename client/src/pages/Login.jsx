    ...
    return (
        <div className="min-h-[70vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md w-full bg-white p-8 rounded-none border border-gray-200">
                <div>
                    <h2 className="mt-2 text-center text-3xl font-black text-black uppercase tracking-tighter">Welcome back</h2>
                    <p className="mt-4 text-center text-sm text-gray-600 font-medium">
                        Or <Link to="/signup" className="font-bold text-black border-b border-black hover:text-gray-500 pb-0.5 transition uppercase tracking-widest text-[10px]">create a new account</Link>
                    </p>
                </div>
